...
### 🏛️ LawMax
> Legal case management platform for Qatar & Egypt

- 🔧 Full-stack dev of 2 integrated legal modules
- 📄 Generic Legal Forms engine with PDF generation
- 🌍 Multi-language (i18n) + 21 bilingual email templates
- 📱 RTL-optimized, fully responsive Arabic UI

**Stack:** `Angular` `ABP Framework` `C#` `Syncfusion` `RxJS`

</td>
<td width="50%" valign="top">

### ⚖️ ALMargaa
> Dual-portal Middle Eastern legal services platform

- 👤 Public portal for lawyers & law firms
- 🛡️ Comprehensive admin dashboard
- 💳 Subscription model for individuals & firms
- 🔐 Full content, user & permissions management

**Stack:** `Angular` `ABP Framework` `.NET` `RxJS`
...
### 🎬 Church Live Stream Studio
> Desktop broadcast studio app · [GitHub →](https://github.com/bahaamagdygit)

- 📡 RTMP streaming to YouTube & Facebook via FFmpeg
- 🎥 Multi-camera management with filters & transforms
- 🖼️ Canvas-based overlay rendering (text + logo + animations)
- 📂 Multi-format support: PPTX · PDF · DOCX · XLSX

**Stack:** `Electron` `React 18` `TypeScript` `FFmpeg` `Vite`

</td>
<td width="50%" valign="top">

### 🛒 Rahim Marketplace — ERP Platform
> Full-cycle ERP marketplace · [GitHub →](https://github.com/bahaamagdygit)

- 🏗️ Nx-style mono-repo: Admin · Vendor · Customer apps
- 📦 4 shared libraries (ui-components, core, data-access, utils)
- ⚡ Angular Signals · standalone components · lazy-loaded routes
- 🔐 JWT auth + role-based guards · Arabic/RTL support

**Stack:** `Angular 20` `.NET Core` `SQL Server` `JWT` `SCSS`
...
### 🧾 Najah Soft — E-Invoicing Platform
> Saudi-based accounting & ZATCA-compliant SaaS

- 🧾 Electronic invoicing UI (create · customize · share)
- 📲 Multi-channel sharing: WhatsApp · Email · PDF
- ✅ ZATCA e-invoicing compliance features
- 📱 RTL-optimized responsive landing page
...
### 🚗 BeKam — Car Price Prediction
> ML-powered used vehicle price estimator · [GitHub →](https://github.com/bahaamagdygit)

- 🤖 XGBoost Regressor model integration
- 👥 Triple interface: User · Admin · Dealer
- 🕸️ Web scraping for data aggregation
- 📊 Full ad & review management dashboard

**Stack:** `ASP.NET MVC` `C#` `Entity Framework` `XGBoost` `SQL Server`
...
<p align="center">
  ...
  &nbsp;
  <a href="https://api.whatsapp.com/send/?phone=201015637375">
